...
// WiFi Credentials
const char* ssid = "Ley Ley Bai";
const char* password = "ayesha01";

// Firebase Configuration
const String FIREBASE_HOST = "iot-lab-11-1339-default-rtdb.firebaseio.com";
const String FIREBASE_AUTH = "kO9Xw6DbUZFKpAkYWeWeTv3YRwul5mpQ4DbGSCuf";
